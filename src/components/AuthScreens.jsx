  ...
  if (step === 98) {
    return (
      <div style={{ ...sty.card, maxWidth: 450, margin: '60px auto', textAlign: 'center', borderTop: `4px solid ${C.blue}` }}>
        ...
        <input type="password" placeholder="••••" value={pinInput} onChange={e => setPinInput(e.target.value)} onKeyDown={e => e.key === 'Enter' && handleLogin()} autoComplete="new-password" style={{ ...sty.input, textAlign: 'center', fontSize: 28, letterSpacing: 10, marginBottom: 20, padding: '15px' }} />
  ...
  if (step === 99) {
    return (
      <div style={{ ...sty.card, maxWidth: 450, margin: '60px auto', textAlign: 'center', borderTop: `4px solid ${C.teal}` }}>
        ...
        <input type="password" placeholder="Ej: A1B2C3" value={pinInput} onChange={e => setPinInput(e.target.value)} onKeyDown={e => e.key === 'Enter' && handleLogin()} autoComplete="new-password" style={{ ...sty.input, textAlign: 'center', fontSize: 24, letterSpacing: 6, marginBottom: 20, textTransform: 'uppercase', padding: '15px' }} />
